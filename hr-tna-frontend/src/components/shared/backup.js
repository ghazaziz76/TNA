    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const formattedData = {
                ...
                companyCategory: companyCategory, // ✅ Automatically categorized size (stored but not displayed)
            ...
            console.log("Submitting Data:", formattedData); // ✅ Debugging Output
       ...
       // ✅ Place console.log statements here, right before the return statement
            ...
            <Card>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <section>
                            ...
                            {/* ✅ 2nd Row: Vision, Mission, Client Charter, Objectives */}
